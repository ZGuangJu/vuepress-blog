...
<font size="5" color="#3eaf7c">第一种  使用 ui 界面创建</font>
...
<font size="5" color="#3eaf7c">第二种  使用命令行创建（方式一）</font>
...
7. 预设的作用就是可以直接使用之前的配置不用 假设之前的预设叫做 `1810`

```js
Please pick a preset: (Use arrow keys)

 ❯ 1810 (vue-router, vuex, less, babel, eslint) 保存的预设
...
<font size="5" color="#3eaf7c">第三种  使用命令行创建（方式二(旧版本)）</font>
